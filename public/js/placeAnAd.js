$(document).ready(function () {
  ...
  function addSuccessMessage(field, id) {
    ...
    if (!successDiv.length) {
      ...
      const newSuccessDiv = $("<div>")
        .attr("role", "alert")
        .attr("data-success", id)
        .addClass("rounded border-s-4 border-green-500 bg-green-50 p-4 mb-4");
      newSuccessDiv.html(
  ...
  function addErrorMessage(field, id) {
    ...
    if (!errorDiv.length) {
      ...
      const newErrorDiv = $("<div>")
        .attr("role", "alert")
        .attr("data-error", id)
        .addClass("rounded border-s-4 border-red-500 bg-red-50 p-4 mb-4");
      newErrorDiv.html(
